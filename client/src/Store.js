...
const Store =({match}) =>{
    ...
    const list = [
    	{id:1,name:'Restaurants',linkcode:'restaurants',images:'https://images.pexels.com/photos/6267/menu-restaurant-vintage-table.jpg?cs=srgb&dl=chairs-menu-restaurant-6267.jpg&fm=jpg'},
